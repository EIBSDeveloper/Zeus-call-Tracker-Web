											...
											<div class="row">
												...
												<div class="col-lg-2 mb-2">
													...
													<div class="d-flex align-items-center justify-content-center form-label text-center">
														<label class="badge badge-info text-white fs-6 fw-bold">78</label>
												...
												<div class="col-lg-2 mb-2">
													...
													<div class="d-block text-center form-label">
														<label class="badge badge-success text-white fs-6 fw-bold">89</label>
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													...
													<div class="d-flex align-items-center justify-content-center form-label text-center">
														<label class="badge badge-info text-black fs-6 fw-bold" style="background-color:#FF7F00 !important;">15</label>
														<label class="text-black fs-6 fw-bold me-1 ms-1">/</label>
														<label class="badge badge-info text-black fs-6 fw-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Average Missed Call Ratio" style="background-color:#FF7F00 !important;">13%</label>
												...
												<div class="col-lg-2 mb-2">
													...
													<div class="d-block text-center form-label">
														<label class="badge badge-danger text-white fs-6 fw-bold">12</label>
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													...
													<table class="table align-middle table-hover fs-7 gy-3 gs-2 list_page">
														...
														<tbody class="text-gray-800 fw-bold fs-7">
															<tr>
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Ragul Sir</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 8585632356</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">02:24:15 PM</label>
																</td>
																<td class="text-start">
																	<label class="badge badge-light-primary fs-7 fw-bold">02:24:56 PM</label>
																</td>
																<td class="text-start">
