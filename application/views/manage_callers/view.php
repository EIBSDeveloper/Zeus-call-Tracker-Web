						...
						<div class="container-xxl" id="kt_content_container">
							<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
								...
								<div class="col-xxl-12">
									<div class="card">
										<div class="p-8 pb-0 border-bottom">
											<div class="row">
												<div class="col-lg-6">
													<div class="text-dark fw-bold mb-2 fs-3">
														<label>View Callers Details</label>
												...
												<div class="col-lg-3">
													...
													<?php if (!empty($caller->image) && file_exists($photo_path) ) { ?>
														<a class="d-block overlay text-center me-3" href="<?php echo $photo_url; ?>" data-fslightbox="lightbox-basic_list">
														    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded w-50px h-50px" style="background-image:url('<?php echo $photo_url; ?>')">
														    </div>
													...
													<?php } else if (file_exists($letter_path)) { ?>
														<a class="d-block overlay text-center me-3" href="<?php echo $letter_path; ?>" data-fslightbox="lightbox-basic_list">
														    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded w-50px h-50px" style="background-image:url('<?php echo $letter_path; ?>')">
														    </div>
														    <div class="overlay-layer card-rounded bg-dark bg-opacity-25 shadow w-50px h-50px">
														        <i class="bi bi-eye-fill text-white fs-2"></i>
														    </div>
														...
														<?php }?>
													 	...
													 	<div class="mb-0 me-2">
															<label class="fs-5 fw-semibold text-black"><?php echo $caller->name ?? "" ; ?></label>
															...
															<div class="d-block fs-6 fw-bold text-gray-700" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Department">[<?php echo $caller->department_name ?? "" ; ?>]</div>
														</div>
												 	</div>
												</div>
												<div class="col-lg-3 mb-2">
													<div class="text-center form-label fs-4 fw-bold">Package</div>
													<div class="d-block text-center form-label text-success fs-4 fw-bold">
														<label><?php echo $caller->package_name ?? "" ; ?></label>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card-body">
											<div class="row">
												<div class="col-lg-2 mb-2">
													<div class="text-center form-label fs-4 fw-bold mb-4">Last Login</div>
													<div class="d-block text-center form-label text-success fs-5 fw-bold"><?php echo $last_login_time ? date('d-M-Y h:i:s A', strtotime($last_login_time)) :' - ' ?></div>
												</div>
												<div class="col-lg-2 mb-2">
													<div class="d-flex align-items-center justify-content-center fs-4 fw-bold text-center form-label mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Outgoing Call">
														<a href="javascript:;" class="bg-gray-200 align-items-center badge badge-light me-2">
															<svg width="17px" height="20px"  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.26" xml:space="preserve">
													...
													<div class="d-flex align-items-center justify-content-center form-label text-center">
														<label class="badge badge-info text-white fs-6 fw-bold"><?php echo sprintf("%02d", $outgoingcall_count); ?></label>
														<label class="text-black fs-6 fw-bold me-1 ms-1">/</label>
														<label class="badge badge-info text-white fs-6 fw-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Average Outgoing Call Ratio">40%</label>
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													<div class="d-flex align-items-center justify-content-center fs-4 fw-bold text-center form-label mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Incoming Call">
														<a href="javascript:;" class="bg-gray-200 align-items-center badge badge-light me-2">
															<svg width="17px" height="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.26" xml:space="preserve">
													...
													<div class="d-block text-center form-label">
														<label class="badge badge-success text-white fs-6 fw-bold"><?php echo sprintf("%02d", $incoming_call_count); ;?></label>
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													<div class="d-flex align-items-center justify-content-center fs-4 fw-bold text-center form-label mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Missed Call">
														<a href="javascript:;" class="bg-gray-200 align-items-center badge badge-light me-2">
															<svg fill="#FF7F00" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
													...
													<div class="d-flex align-items-center justify-content-center form-label text-center">
														<label class="badge badge-info text-black fs-6 fw-bold" style="background-color:#FF7F00 !important;"><?php echo sprintf("%02d", $missedcall_count); ?></label>
														<label class="text-black fs-6 fw-bold me-1 ms-1">/</label>
														<label class="badge badge-info text-black fs-6 fw-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Average Missed Call Ratio" style="background-color:#FF7F00 !important;"><?php echo number_format($missed_call_ratio); ?>%</label>
														<!-- Missed Call Formulae Start -->
														<!-- 
															Missed Call Ratio = (Missed Call / (Incoming Call + Missed Call + Rejected Call)) * 100
															Missed Call Ratio = (15 / (89 + 15 + 12)) *100 = 12.93 %
														 -->
														<!-- Missed Call Formulae end -->
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													<div class="d-flex align-items-center justify-content-center fs-4 fw-bold text-center form-label mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Missed Call">
														<a href="javascript:;" class="bg-gray-200 align-items-center badge badge-light me-2">
															<svg fill="#ff0000" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
																<g id="SVGRepo_bgCarrier" stroke-width="0"/>
																<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
													...
													<div class="d-block text-center form-label">
														<label class="badge badge-danger text-white fs-6 fw-bold"><?php echo sprintf("%02d", $rejected_call_count) ;?></label>
													</div>
												</div>
												<div class="col-lg-2 mb-2">
													<div class="d-flex justify-content-lg-end justify-content-center gap-2">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																	<div class="px-7 py-5" data-kt-user-table-filter="form">
																		<form method="post" action="<?php echo base_url() ?>Manage_callers/view_callers/<?php echo $caller->user_id ;?>" id="fill_form">
																			<div class="scroll-y mh-325px">
																				...
																				<div class="mb-2">
																					...
																					<input type="text" class="form-control form-control-lg_1 form-control-solid" placeholder="Enter Mobile No" oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 10)" name="mobile_fill" value="<?php echo $mobile_fill ?? "" ?>">
																				</div>
																				<div class="mb-2">
																					<label class="form-label">Calls Type</label>
																					<select class="form-select form-select-solid" data-control="select2" name="call_type_fill">
																						<option value="">All</option>
																						<option value="1">Incoming Calls</option>
																						<option value="0">Outgoing Calls</option>
																						<option value="2">Missed Calls</option>
																						<option value="3">Rejected Calls</option>
																					</select>
																				</div>
																				<!--begin::Input group-->
																				<div class="mb-2">
																			...
																			<div class="d-flex justify-content-end">
																				<a href="<?php echo base_url(); ?>Manage_callers/view_callers/<?php echo $caller->user_id ;?>" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset">Reset</a>
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<table class="table align-middle table-hover fs-7 gy-3 gs-2 list_page">
														...
														<tbody class="text-gray-800 fw-bold fs-7">
																	...
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			...
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 8956231245</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Ashwin</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 9096562323</label>
																			</div>
																		</div>
																 	</div>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">29-Sep-2024</label>
																</td>
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">03:20:15 PM</label>
																</td>
																<td class="text-start">
																	<label class="badge badge-light-primary fs-7 fw-bold">03:24:15 PM</label>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">00:04:00</label>
																</td>
																<td>
															...
															<tr style="background-color:#ffc184 !important;">
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Ram Kumar S</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 8996561212</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">03:02:40 PM</label>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">-</label>
																</td>
															...
															<tr>
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Kathiravan E</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 9096202012</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">02:40:10 PM</label>
																</td>
																<td class="text-start">
																	<label class="badge badge-light-primary fs-7 fw-bold">02:40:30 PM</label>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">00:00:20</label>
																</td>
															...
															<tr>
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Suresh V</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 9856457878</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">01:30:33 PM</label>
																</td>
																<td class="text-start">
																	<label class="badge badge-light-primary fs-7 fw-bold">01:32:30 PM</label>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">00:02:57</label>
																</td>
																<td>
																	<label class="badge badge-success fs-7 text-white fw-bold">Incoming Call</label>
																</td>
															...
															<tr style="background-color:#ff7979 !important;">
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Naveen M</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 9620201245</label>
																			</div>
																		</div>
																 	</div>
																</td>
																...
																<td class="text-start">
																	<label class="badge badge-light-info fs-7 fw-bold">01:25:45 PM</label>
																</td>
																<td class="text-start">
																	<label class="fs-7 text-black fw-bold">-</label>
																</td>
													...
													<div class="row">
														<div class="col-lg-3">Showing <?php echo $page; ?> to <?php echo (($page + $perpage_count) > count($caller_log)) ? count($caller_log) : $page + $perpage_count; ?> of <?php echo count($caller_log); ?> entries</div>
														<div class="col-lg-9 d-flex justify-content-end">
															...
															<form method="POST" id="filter_form" action="" enctype="multipart/form-data">
																...
																<input type="hidden" id="mobile_fill" name="mobile_fill" value="<?php echo $mobile_fill ?? ''; ?>">
																<input type="hidden" id="call_type_fill" name="call_type_fill" value="<?php echo $call_type_fill ?? ''; ?>">
		    ...
		    <div class="modal-dialog modal-md">
		        ...
		        <div class="modal-content rounded">
		            ...
		            <div class="modal-body pt-0 pb-15 px-5 px-xl-10">
		                <!--begin::Heading-->
						<form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Manage_callers/add_unknown_caller" id="add_caller_form">
