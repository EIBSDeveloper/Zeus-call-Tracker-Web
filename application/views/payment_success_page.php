										...
										<div class="card-body px-6">
											<div class="d-flex flex-center mb-3">
												<a href="javascript:;" class="text-center">
									                <img alt="Logo" src="<?php echo base_url();?>assets/Images/logo_bg.png" class="w-350px h-120px me-2">
									            </a>
											</div>
											...
											<div class="d-grid flex-center">
												<div class="card bg-success h-100 w-lg-450px shadow">
													<div class="card-body pt-2">
														...
														<h2 class="fw-bold text-white text-center mb-0 pb-2 pt-4">Payment Successfull !</h2>
														<div class="fs-6 fw-bold mb-3 text-center text-white">Hooray! You have completed your payment.</div>
														...
														<div class="row">
															<div class="col-12 text-center mb-3">
																<div class="badge badge-light-secondary">
																	...
																	<label class="fs-3 fw-bold mb-1 me-2 ms-2">/</label>
																	<label class="fs-4 fw-bold mb-1">1 Month</label>
																	<label class="fs-4 fw-bold mb-1 ms-2 me-2">(10 Callers)</label>
																</div>
															</div>
														</div>
														<hr class="text-gray-100">
														<div class="row">
															...
															<div class="col-12 text-center mb-1">
																...
																<label class="fs-2hx text-white fw-bold mb-1">2,950</label>
															</div>
															<div class="col-12 text-center mb-1">
