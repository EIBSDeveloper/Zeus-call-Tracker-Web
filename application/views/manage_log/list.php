											...
											<div class="d-flex justify-content-lg-end justify-content-center gap-2">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<form method="post" action="<?php echo base_url() ?>Manage_log" id="fill_form">
															<div class="scroll-y mh-325px">
																<div class="mb-2">
																	<label class="form-label">Communicator</label>
																	<input type="text" class="form-control form-control-lg_1 form-control-solid" placeholder="Enter Communicator Name" name="communicator_fill" >
																</div>
																<div class="mb-2">
																	<label class="form-label">Caller</label>
																	<input type="text" class="form-control form-control-lg_1 form-control-solid" placeholder="Enter Caller Name" name="caller_fill">
																</div>
																<div class="mb-2">
																	<label class="form-label">Mobile No</label>
																	<input type="text" class="form-control form-control-lg_1 form-control-solid" placeholder="Enter Mobile No" name="mobile_fill">
																</div>
																<div class="mb-2">
																	<label class="form-label">Status</label>
																	<select class="form-select form-select-solid" data-control="select2" name="status_fill">
																		<option value="">All</option>
																		<option value="1" <?php echo $status_fill=="1" ? "selected":"";?>>Incoming Calls</option>
																		<option value="0" <?php echo $status_fill=="0" ? "selected":"";?>>Outgoing Calls</option>
																		<option value="2" <?php echo $status_fill=="2" ? "selected":"";?>>Missed Calls</option>
																		<option value="3" <?php echo $status_fill=="3" ? "selected":"";?>>Rejected Calls</option>
																	</select>
																</div>
																<div class="mb-2">
															...
															<div class="d-flex justify-content-end">
																<a href="<?php echo base_url(); ?>Manage_log" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset">Reset</a>
												...
												<div>
												<button type="button" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" class="btn btn-sm btn-primary me-3 mb-4"> <i class="fa-solid fa-file-export fs-7"></i> Export</button>
													...
													<div class="row">
														...
														<div class="col-lg-9 d-flex justify-content-end">
															...
															<form method="POST" id="filter_form" action="" enctype="multipart/form-data">
																...
																<input type="hidden" id="status_fill" name="status_fill" value="<?php echo $st_fill ?? ''; ?>">
																...
																<input type="hidden" id="caller_fill" name="caller_fill" value="<?php echo $caller_fill ?? ''; ?>">
																<input type="hidden" id="communicator_fill" name="communicator_fill" value="<?php echo $communicator_fill ?? ''; ?>">
		...
		<script>
			$(document).ready(function() {
				$(".move_to").on("click", function() {
					value = $(this).val();
					// alert(value);
					$('#filter_form').attr('action', "<?php echo base_url(); ?>Manage_log/?page=" + value);
					$("#filter_form").submit();
					e.preventDefault();
				});
			});
