										...
										<div class="card-header pt-5 align-items-center">
											<h3 class="card-title align-items-start flex-column">
												<div class="text-dark fw-bold mb-2 fs-3">
													...
													<label class="badge badge-warning fw-bold fs-3 text-black">Date [01-Sep-2024 to 01-Oct-2024]</label>
												</div>
												<div class="d-flex">
											...
											<div class="row">
												<div class="col-lg-3 mb-2">
													...
													<div class="text-center">
														<label class="badge badge-info text-white fs-2 fw-bold">01</label>
												...
												<div class="col-lg-3 mb-2">
													...
													<div class="text-center">
														<label class="badge badge-success text-white fs-2 fw-bold">01</label>
													</div>
												</div>
												<div class="col-lg-3 mb-2">
													...
													<div class="text-center">
														<label class="badge badge-info text-black fs-2 fw-bold" style="background-color:#FF7F00 !important;">01</label>
														<label class="text-black fs-2 fw-bold me-1 ms-1">/</label>
														<label class="badge badge-info text-black fs-2 fw-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Average Missed Call Ratio" style="background-color:#FF7F00 !important;">99%</label>
													</div>
												</div>
												<div class="col-lg-3 mb-2">
													...
													<div class="text-center">
														<label class="badge badge-danger text-white fs-2 fw-bold">01</label>
													</div>
												</div>
												<div class="col-lg-12">
																...
																<td class="text-start">
																	<div class="d-flex align-items-center">
																		<a class="d-block overlay text-center me-3" href="javascript:;">
																	 	...
																	 	<div class="mb-0 me-2">
																			<label class="fs-7 fw-semibold text-black">Aasath R</label>
																			<div class="d-block">
																				<label class="fs-8 text-black fw-bold">+91 9856231245</label>
																			</div>
																		</div>
																 	</div>
																</td>
