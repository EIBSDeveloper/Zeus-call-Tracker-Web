								...
								<div class="col-xxl-12">
										...
										<div class="card-header pt-5 border-bottom-0 align-items-center">
											<h3 class="card-title align-items-start flex-column">
												<div class="text-dark fw-bold mb-2 fs-3">
													...
													<div class="badge badge-success text-black fw-bold fs-4 rounded" style="background: #FF7F00 !important;">Blocked Subscriber</div>
												</div>
												<div class="d-flex">
					                ...
					                <a href="<?php echo base_url(); ?>Manageusers" class="d-flex align-items-center fw-semibold text-gray-500 fs-6">Subscription Management</a>
											...
											<div class="text-center">
												<label class="fw-bold fs-5">Gokul E  - 8956231245</label>
												<div class="d-block">
													<label class="badge badge-primary fs-5 fw-bold text-white">Rajexim Private Limited</label>
													<label class="badge badge-danger fs-5 fw-bold text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Renewal Days">23 Days</label>
												</div>
											</div>
										</div>
													...
													<div class="row mb-4">
														<div class="col-lg-4">
															<div class="row mb-2">
																...
																<label class="col-6 fs-5 fw-bold">20-Sep-2024</label>
															</div>
															<div class="row mb-2">
																<label class="col-5 fs-6 fw-semibold">Subscriber</label>
																<label class="col-1 fs-6 fw-bold">:</label>
																<label class="col-6 fs-5 fw-bold">Gokul E</label>
															</div>
															<div class="row mb-2">
																<label class="col-5 fs-6 fw-semibold">Company</label>
																<label class="col-1 fs-6 fw-bold">:</label>
																<label class="col-6 fs-5 fw-bold">Rajexim Private Limited</label>
															</div>
															<div class="row mb-2">
																<label class="col-5 fs-6 fw-semibold">Mobile No</label>
																<label class="col-1 fs-6 fw-bold">:</label>
																<label class="col-6 fs-5 fw-bold">8956231245</label>
															</div>
															<div class="row mb-2">
																<label class="col-5 fs-6 fw-semibold">Email ID</label>
																<label class="col-1 fs-6 fw-bold">:</label>
																<label class="col-6 fs-5 fw-bold">gokul@gmail.com</label>
															</div>
														</div>
														<div class="col-lg-6">
															<div class="row mb-2">
															...
															<div class="row mb-2">
																...
																<div class="col-6 fs-5 fw-bold">
																	<label class="badge badge-warning text-black fs-6 fw-bold">12</label>
																</div>
															</div>
															<div class="row mb-2">
																...
																<div class="col-6">
																	...
																	<label class="fs-5 fw-bold">3,000</label>
																</div>
															</div>
															<div class="row mb-2">
																...
																<label class="col-1 fs-6 fw-bold">:</label>
																<div class="col-6 fs-5 fw-bold">
																	<label class="badge badge-success text-white fs-7 fw-bold">20-Sep-2024</label>
																	<label class="text-black fs-6 fw-bold me-1 ms-1">|</label>
																	<label class="badge badge-danger text-white fs-7 fw-bold">19-Oct-2024</label>
																</div>
															</div>
														</div>
														<div class="col-lg-2">
															...
															<table class="table table-striped table-row-bordered gy-2 gs-7 list_page">
																...
																<tbody class="text-gray-800 fw-bold fs-7">
																	<tr>
																		...
																		<td align="start">
																			<div class="badge badge-success fs-8">20-Sep-2024</div>
																			<div class="d-block mt-1">
																				<div class="badge badge-danger fs-8">19-Oct-2024</div>
																			</div>
																		</td>
																		<td align="right">
                                        ...
                                        <label>3,000</label>
																		...
																		<td>
																			<div class="badge badge-warning text-black fw-semibold fs-7">23 Days</div>
																		</td>
																		<td>
