								...
								<div class="col-xxl-12">
					                ...
					                <a href="<?php echo base_url(); ?>Manageusers" class="d-flex align-items-center fw-semibold text-gray-500 fs-6">Subscription Management</a>
										...
										<ul class="nav nav-tabs nav-line-tabs fs-5 px-10 mt-2">
										    <li class="nav-item">
										        <a class="nav-link  text-black fw-bold"  href="<?php echo base_url(); ?>Subscription_management/view_subscriber/<?php echo $view->subscriber_id; ?>">Subscriber Details</a>
										    </li>
										    <li class="nav-item">
										        <a class="nav-link active text-black fw-bold" data-bs-toggle="tab" href="#kt_tab_view_payment_details">Payment Details</a>
										    </li>
										</ul>
										<!--begin::Card body-->
										<div class="card-body">
											<div class="tab-content" id="view_content">
												<div class="tab-pane " id="kt_tab_view_subscriber_details" role="tabpanel">
													<?php
												...
												<div class="tab-pane fade show active" id="kt_tab_view_payment_details" role="tabpanel">
													<div class="row">
														<div class="col-lg-12">
															<table class="table table-striped table-row-bordered gy-2 gs-7 list_page">
																...
																<?php if(isset($payment_list)){?>
																	<?php foreach ($payment_list as $i => $sublist) { ?>
																		<?php 
																			$duration = $sublist->duration == '3'? 'Life Time':( $sublist->duration == '1' ? 'Month':'Year')
																		?>
																		<tr>
																			<td><?php echo date($common_date,strtotime($sublist->created_at)) ?></td>
																			<td>
																			...
																			<td class="text-start"><?php echo $sublist->no_of_callers ?></td>
																			<td align="start">
																				<div class="badge badge-success fs-8"><?php echo date($common_date,strtotime($sublist->start_date)) ?></div>
																				<div class="d-block mt-1">
																					<div class="badge badge-danger fs-8"><?php echo date($common_date,strtotime($sublist->end_date)) ?></div>
																				</div>
																			</td>
																			<td align="right">
																				...
																				<label><?php echo IND_money_format($sublist->paid_amount);  ?></label>
																				</div>
																			</td>
																			<td>
