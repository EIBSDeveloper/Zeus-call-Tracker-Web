<?php $this->load->view("common.php"); ?>
	...
	<body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root">
			...
			<style>
			    body {
			        background-image: url('<?php echo base_url()?>assets/Images/landing_page_logo_1.jpg');
			    }
			    .txt_shadow{
				            ...
				            <div class="d-flex flex-center flex-column flex-column-fluid">
								...
								<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" id="kt_sing_in_two_factor_form" autocomplete="off" >
								    ...
								    <div class="text-center">
								        <!--begin::Title-->
								        <h1 class="text-white fw-bold fs-2hx mb-6">Admin</h1>
								        <!--end::Title-->
								    </div>
								    ...
								    <div class="fv-row mb-2 fv-plugins-icon-container">
								        <label class="mb-1 fw-bold fs-3 text-white">We Sent a Verification Code to Your Mobile No.</label>
								        <div class="d-block text-center">
								        	<label class="badge badge-success text-center fw-bold text-white fs-3"><?php echo $mobile_no; ?></label>	
											<input type="hidden" id="user_mobile" name="mobile" value="<?php echo $mobile_no; ?>" />	
											<label for="" class = "text-white"><?php echo $otp; ?></label>
								        </div>
								    </div>
								    <!--begin::Wrapper-->
								    <div class="mb-4 mt-4 d-flex justify-content-between">
							          <div class="float-start">
							          	<label class="fw-semibold text-white fs-6">Enter your 6 digit security code</label>
							          </div>
								    ...
								    <div class="mb-4">
										<div class="d-flex flex-wrap flex-stack">
											<input type="text" id="code_1" name="code_1" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" autofocus/>
											<input type="text" id="code_2" name="code_2" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" />
											<input type="text" id="code_3" name="code_3" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" />
											<input type="text" id="code_4" name="code_4" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" />
											<input type="text" id="code_5" name="code_5" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" />
											<input type="text" id="code_6" name="code_6" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" class="form-control bg-transparent h-60px w-60px fs-2qx text-center text-white mx-1 my-2" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" value="" />
										</div>
										<div class="text-danger mt-2" id="code_trans_err"></div>
									</div>
							        <div class="text-center mb-3 fw-semibold text-dark" id="resd_otp_link" style="display: none !important;"><span class="text-white fs-5">Didn't get the code?</span>
								    ...
								    <div class="d-flex align-items-center flex-lg-row flex-column mb-4 pt-4 gap-3">
								    	<a href="<?php echo base_url(); ?>Login/logout" class="btn btn-primary w-lg-50 w-100">Change Mobile No</a>
										<!-- <button type="submit" class="btn btn-primary w-lg-50 w-100" id="verify_otp" >Verify</button> -->
								    ...
								    <!-- <div class="text-center pt-4">
									    <div class="badge badge-success fs-6 fw-semibold px-6">Login Successfully...</div>
									</div>
									<div class="text-center pt-4">
        ...
        <script>
		  function resend_otp_func() {
		    ...
		    start_timer();
			$.ajax({
				url: "<?php echo base_url(); ?>Login/resend_otp", // Replace with the correct URL
				type: "POST",
	...
	<!-- <script>
		function otp_password_validation() {
			...
			// Concatenate the values of all code fields
			var verify = codes.join('');
